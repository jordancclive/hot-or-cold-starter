...
function generateFeedback(){
	if(secretNum == userGuess){
		winner();
	} else if(Math.abs(secretNum - userGuess) < 5){
		userFeedback = 'burning hot';
	} else if(Math.abs(secretNum - userGuess) < 10){
		userFeedback = 'hot';
	} else if(Math.abs(secretNum - userGuess) < 20 && Math.abs(secretNum - userGuess) > 9){
		userFeedback = ' Kinda hot';
	} else if(Math.abs(secretNum - userGuess) < 30 && Math.abs(secretNum - userGuess) > 19){
		userFeedback = 'luke warm';
	} else if(Math.abs(secretNum - userGuess) < 50 && Math.abs(secretNum - userGuess) > 30){
		userFeedback = 'cold';
	} else {
